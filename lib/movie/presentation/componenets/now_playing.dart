...
class NowPlayingComponenet extends StatelessWidget {
  final MoviesState nowPlayingState;
  const NowPlayingComponenet({
  ...
  Widget build(BuildContext context) {
    return FadeIn(
      ...
      child: CarouselSlider(
        ...
        items: nowPlayingState.nowPlayingMovies.map(
          (item) {
